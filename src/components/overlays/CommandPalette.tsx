...
export function CommandPalette() {
  ...
  return (
    <>
      {/* Mobile floating trigger button — only visible on small screens */}
      {isMobile && !isOpen && (
        <motion.button
              ...
              <div className="w-full max-w-lg mx-4 bg-white/90 backdrop-blur-xl border border-gray-200 rounded-2xl overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.1)]">
                ...
                <div className="flex items-center justify-between px-5 py-3 bg-gray-50/80 border-t border-gray-100 text-xs text-gray-500">
                  <div className="flex items-center gap-4">
                    <span className="hidden sm:flex items-center gap-1.5"><kbd className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-[10px] font-bold shadow-sm">↑↓</kbd> navigate</span>
                    <span className="hidden sm:flex items-center gap-1.5"><kbd className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-[10px] font-bold shadow-sm">↵</kbd> select</span>
                    <span className="sm:hidden text-gray-400">Tap to select</span>
                  </div>
                </div>
              </div>
            </motion.div>
